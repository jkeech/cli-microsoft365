...
const command: Command = require('./page-section-list');
...
describe(commands.PAGE_SECTION_LIST, () => {
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.PAGE_SECTION_LIST), true);
  });
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.PAGE_SECTION_LIST));
  });
