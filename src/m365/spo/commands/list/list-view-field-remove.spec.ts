...
describe(commands.LIST_VIEW_FIELD_REMOVE, () => {
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.LIST_VIEW_FIELD_REMOVE), true);
  });
  ...
  it('fails validation if the url option not specified', () => {
    const actual = (command.validate() as CommandValidate)({ options: { listId: '0CD891EF-AFCE-4E55-B836-FCE03286CCCF', viewId: 'cc27a922-8224-4296-90a5-ebbc54da2e85', fieldId: '330f29c5-5c4c-465f-9f4b-7903020ae1ce' } });
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.LIST_VIEW_FIELD_REMOVE));
  });
