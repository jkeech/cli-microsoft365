...
describe(commands.TEAMS_REPORT_DEVICEUSAGEUSERDETAIL, () => {
  ...
  it('has correct name', () => {
    assert.equal(command.name.startsWith(commands.TEAMS_REPORT_DEVICEUSAGEUSERDETAIL), true);
  });
  ...
  it('has help referring to the right command', () => {
    ...
    cmd.help({}, () => { });
    assert(find.calledWith(commands.TEAMS_REPORT_DEVICEUSAGEUSERDETAIL));
  });
